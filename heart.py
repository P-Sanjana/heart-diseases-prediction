...
st.write(""" # Heart Disease Prediction Site
This site predicts that *the person has heart disease or not* 
""")
def user_input_features():
    ...
    st.write("""**9. Peak Excercise (The slope of the peak exercise ST segment) :**""")
